...
*/
#include <kuka/fri/FRIMessages.pb.h>
#include <kuka/fri/LBRCommand.h>
#include <kuka/fri/LBRState.h>
#include <kuka/pb/pb_frimessages_callbacks.h>
...
namespace kuka {
    namespace fri {
        ...
        void LBRCommand::setJointPosition(const double* values)
        {
            ...
            tRepeatedDoubleArguments* dest = (tRepeatedDoubleArguments*)_message->commandData.jointPosition.value.arg;
        ...
        void LBRCommand::setTorque(const double* torques)
        {
            ...
            tRepeatedDoubleArguments* dest = (tRepeatedDoubleArguments*)_message->commandData.jointTorque.value.arg;
